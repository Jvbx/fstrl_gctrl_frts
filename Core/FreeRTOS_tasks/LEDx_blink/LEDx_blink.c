      ...
      if (arg == 0)
         ...
         // if(osSemaphoreWait(mt_LCD_freeHandle, 0) == osOK) {
          ...
          //LCD1602A_SetCursorPos(0, 1); //Установка курсора
              ...
              lcd_msg_buf.pos_x = 0;
              lcd_msg_buf.pos_y = 1;
              sprintf(lcd_msg_buf.data, "LED1Task_enter" + '\0');
         ...
         // LCD1602A_PrintStr("LED1Task_exit" + '\0');
          ...
          lcd_msg_buf.pos_x = 0;
          lcd_msg_buf.pos_y = 1;
          sprintf(lcd_msg_buf.data, "LED1Task_exit" + '\0');
          msgcnt = uxQueueSpacesAvailable(msgto_gkt_LCDHandle);
          if ( msgcnt)
              {
              xQueueSend(msgto_gkt_LCDHandle, &lcd_msg_buf, portMAX_DELAY);
          ...
          taskYIELD();
              ...
              lcd_msg_buf.pos_x = 1;
              lcd_msg_buf.pos_y = 1;
              sprintf(lcd_msg_buf.data, "LED2Task_enter" + '\0');
              ...
              if ( msgcnt)
                ...
                // LCD1602A_SetCursorPos(1, 1); //Установка курсора
                 ...
                 lcd_msg_buf.pos_x = 1;
                 lcd_msg_buf.pos_y = 1;
                 sprintf(lcd_msg_buf.data, "LED2Task_exit" + '\0');
